    ...
    return (
        <div className={"flex flex-row pt-1 pb-2 items-center"}>
            ...
            <div className={"flex flex-row ml-auto gap-1 text-3xl sm:text-xl"}>
                ...
                <StatsButton className={"rounded-full p-1 bg-transparent hover:bg-transparent transition-colors dark:hover:text-bg-secondary " + 
                ...
                <SettingsButton className={"rounded-full p-1 bg-transparent hover:bg-transparent transition-colors dark:hover:text-bg-secondary " + 
